      ...
      <Frame title="PA Performance" icon="🧑‍💼" color="#16a34a"
        ...
        <div className="filter-bar" style={{ marginBottom:12 }}>
          ...
          <span style={{ marginLeft:'auto', fontSize:11, color:'var(--txt3)' }}>
            ...
            {(tlFilter!=='All' || apmFilter!=='All') && ` (filtered from ${allAdvisors.length})`}
          </span>
        </div>
              ...
              <tbody>
                {filteredPA.map((r, i) => (
                  <tr key={i} style={{
                    ...
                    <td style={{ fontWeight:700 }}>{r.ccActuals != null ? Math.round(r.ccActuals) : '—'}</td>
                    ...
                    <td style={{ fontWeight:700 }}>{r.pttActuals != null ? Math.round(r.pttActuals) : '—'}</td>
